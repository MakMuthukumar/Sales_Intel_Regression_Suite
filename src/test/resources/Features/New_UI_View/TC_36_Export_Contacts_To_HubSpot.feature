  Feature: To validate Export Contact To HubSpot
  ...
  @First @Sanity @Credit_Export
  Scenario: To validate application Export to HubSpot company details
    When Click on Contact Radio Button
    And Click on Search Button
    And Click on 1st Contact checkbox
		And Click on Contact Bulk Actions Dropdown
		And Click on Contact Export to HubSpot Option
		And Click on Export As Lead Option
    And Perform Export Contacts To HubSpot Window
